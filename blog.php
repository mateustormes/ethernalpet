...
<div class="container pt-5">
    ...
    <div class="row pb-3">
        <?php
        if(count($postsPagina) > 0){
            foreach ($postsPagina as $post):
                    ...
                    <div class="card border-0 mb-2">
                        ...
                        <div class="card-body bg-light p-4">
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <small class="mr-2"><i class="fa fa-folder text-muted"></i> <?= $post['numero_itens_post']; ?></small>
                                <small class="mr-2"><i class="fa fa-comments text-muted"></i> <?= $post['numero_comentarios']; ?></small>
                            </div>
            ...
            <div class="col-lg-12 text-center  mb-5 pt-5">
                <p>Ainda não há nenhuma publicação cadastrada nessa categoria</p>
            </div>
        <?php } ?>
